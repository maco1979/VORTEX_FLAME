#!/usr/bin/env python3
"""Cezanne 7B Full Retrain — Stage1: CS Math 8K
...
DATA_FILE = "/mnt/d/VORTEX_FLAME/soul_training_data/cezanne/cezanne_s1_cs_math_8k.json"
...
REGRESSION_QUESTIONS = [
    ...
    {"q": "Explain the time complexity of binary search.", "kw": ["log", "binary", "search", "o("]},
    {"q": "What is the difference between a stack and a queue?", "kw": ["stack", "queue", "lifo", "fifo"]},
    {"q": "Explain Big-O notation with examples.", "kw": ["big-o", "notation", "complexity"]},
]
...
def main():
    ...
    print(f"  {SOUL_NAME} {STAGE}: CS Math 8K", flush=True)
    ...
    if isinstance(raw, dict):
        samples = raw.get("data", raw.get("samples", []))
    else:
        samples = raw
