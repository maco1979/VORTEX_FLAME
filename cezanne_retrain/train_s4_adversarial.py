#!/usr/bin/env python3
"""Cezanne 7B Adversarial Training — 8B-corrected data
From Base with S1+S2+S3+supplement+adversarial data, r=16
Safety: Loss gate + Regression gate + Auto-rollback
...
DATA_FILES = [
    ...
    "cezanne_s3_cs_depth_8k.json",
    "cezanne_s3_supplement.json",
    "cezanne_adversarial_training.json",
]
...
def main():
    ...
    print(f"  {SOUL_NAME} {STAGE}: Adversarial Training (8B-corrected)", flush=True)
    ...
    print(f"  Safety: Loss Gate ({MAX_LOSS}) + Regression Gate (10Q)", flush=True)
    print(f"{'='*60}", flush=True)
    ...
    for attempt in range(1, MAX_RETRIES + 1):
        ...
        log_data = {
            ...
            "regression_questions": len(REGRESSION_QUESTIONS),
