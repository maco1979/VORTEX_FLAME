#!/usr/bin/env python3
"""
Benchmark 8B Cezanne_PRO Stage2 ONLY - single model load
"""
...
def main():
    ...
    print(f"Loading 8B + Stage2 LoRA...", flush=True)
    ...
    log_path = r"D:\VORTEX_FLAME\hermes_logs\cezanne_8b\stage2_benchmark.json"
